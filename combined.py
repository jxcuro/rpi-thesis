...
# Version: 1.3.2 - Syntax Check, Checkboxes, Resize, Sequential Naming, GUI Fix
...
def capture_and_save_data():
    ...
    # Get Sensor Readings (using more samples for capture accuracy)
...
def update_ldc_reading():
    ...
    # Get current average reading for this interval
...
def setup_gui():
    ...
    window = tk.Tk()
    window.title("Sensor Data Acquisition Tool v1.3.2")
    ...
    # Set minimum row height to prevent GUI shifts during calibration messages
    feedback_row_min_height = int(feedback_font.metrics('linespace') * 2.5) # Approx 2.5 lines high
    ...
    target_var.set(TARGET_OPTIONS[0]) # Default selection
